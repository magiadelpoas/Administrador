<?php
/**
 * Endpoint simple para crear reservas desde el landing page
 * Sin autenticación requerida - acceso libre
 */

// Configurar headers CORS para permitir el landing page
...
try {
    ...
    if ($stmt->execute()) {
        ...
        // Log de éxito
        error_log("Reserva creada exitosamente - ID: {$newId}");
    ...
    error_log("Error en crear_reserva.php: " . $e->getMessage());
