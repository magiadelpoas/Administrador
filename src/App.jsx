        ...
        <div className="form-container">
          ...
          <form onSubmit={onSubmit}>
            ...
            <input
              ...
              id="totalDepositado"
              className={`form-input ${errorFields.includes('totalDepositado') ? 'error' : ''}`}
              placeholder="0"
            ...
            <StyledDatePicker
              ...
              slotProps={{
                textField: {
                  disabled: !formData.cabana,
                  className: errorFields.includes('fechaIngreso') ? 'error' : '',
                },
              }}
            />
            ...
            <StyledDatePicker
              ...
              slotProps={{
                textField: {
                  disabled: !formData.cabana,
                  className: errorFields.includes('fechaSalida') ? 'error' : '',
                },
              }}
            />
